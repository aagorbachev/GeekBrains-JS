...
function createChessBoard() {
    ...
    let upperLetters = createLettersRow()
    upperLetters.classList.add('upper-letters')

    let lowerLetters = createLettersRow()
    lowerLetters.classList.add('lower-letters')

    let leftNumbers = createNumbersColumn()
    leftNumbers.classList.add('left-numbers')

    let rightNumbers = createNumbersColumn()
    rightNumbers.classList.add('right-numbers')

    wrapper.append(upperLetters, leftNumbers, chessZone, rightNumbers, lowerLetters)
